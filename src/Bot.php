<?php
/**
* customised by Duncan Sterken (duncte123)
**/
    ...
    public function __construct(array $config = [], $loop = null, $log = null)
    {
        ...
        $this->discord->on('ready', function ($discord) {
            ...
            $this->discord->on('message', function (Message $message) {
              $this->log->addInfo("New Message From User {$message->author->username}#{$message->author->discriminator} ({$message->author})  '{$message->content}'");
